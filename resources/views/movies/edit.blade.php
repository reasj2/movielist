...
<div class="container mx-auto py-10">
    <h1 class="text-3xl font-bold text-orange-800 dark:text-orange-300 mb-6">Edit Movie</h1>
    ...
    <form action="{{ route('movies.update', $movie) }}" method="POST">
        ...
        <div class="mb-4">
            ...
            <input type="text" name="title" value="{{ old('title', $movie->title) }}" class="w-full p-2 rounded border">
        </div>
        <div class="mb-4">
            <label class="block text-gray-700 dark:text-gray-200">Genre</label>
            <input type="text" name="genre" value="{{ old('genre', $movie->genre) }}" class="w-full p-2 rounded border">
        </div>
        <div class="mb-4">
        ...
        <div class="mb-4">
            ...
            <input type="number" name="rating" min="1" max="10" value="{{ old('rating', $movie->rating) }}" class="w-full p-2 rounded border">
        </div>
